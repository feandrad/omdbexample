package feandrad.ombdexample.utils.string;
...
public final class StringHelper {
	 ...
	 */
	public static String computeSha1OfString(final String message) throws
	 ...
	 *                                       shouldn't bother catching this exception
	 */
	public static String computeMd5OfByteArray(final byte[] arg) throws
			UnsupportedOperationException {
		try {
	 ...
	 */
	public static String truncate(final String str, final int length) throws
